 ...
 */
public class CrudInBackground extends AsyncTask<String, Void, String> {

    public OnTaskCompleted delegate;

    public CrudInBackground(OnTaskCompleted delegate){
        this.delegate = delegate;
    }

    @Override
    protected String doInBackground(String... params) {
        String response = executeSQL(params[0], params[1], params[2]);
    ...
    private String executeSQL(String sql, String requestURL, String apiKey){
