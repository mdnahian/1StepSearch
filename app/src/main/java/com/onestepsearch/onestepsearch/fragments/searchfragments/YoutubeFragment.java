...
public class YoutubeFragment extends Fragment {
    ...
    private class DownloadYoutubeString extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            progressDialog.setMessage("Retrieving Search Results...");
        ...
        protected void onPostExecute(String s) {
            ...
            if(s == null){
                ...
                progressDialog.setMessage("Displaying Search Results...");
                parseYoutubeJSON(s);
            }
        }
            ...
            if(!video.isDownloading()) {
                ...
                downloadBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        DownloadYouTubeLink downloadYouTubeLink = new DownloadYouTubeLink(downloadBtn, progressBar, video, InputFilter.encodeFileName(video.getTitle()) + ".mp4");
